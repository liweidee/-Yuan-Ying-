...
import { cheerio, JSONPath } from './drpy-core.min.js';
...
// 导出兼容接口
export const pdfa = (html, parse) => defaultInstance.pdfa(html, parse);
export const pdfh = (html, parse, baseUrl) => defaultInstance.pdfh(html, parse, baseUrl);
export const pd = (html, parse, baseUrl) => defaultInstance.pd(html, parse, baseUrl);
export const pjfh = (html, parse, addUrl) => defaultInstance.pjfh(html, parse, addUrl);
export const pj = (html, parse) => defaultInstance.pj(html, parse);
export const pjfa = (html, parse) => defaultInstance.pjfa(html, parse);
export const pdfl = (html, parse, list_text, list_url, MY_URL) => defaultInstance.pdfl(html, parse, list_text, list_url, MY_URL);
export const pq = (html) => defaultInstance.pq(html);
