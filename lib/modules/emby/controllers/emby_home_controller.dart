...
class EmbyHomeController extends GetxController {
  final EmbyServerController serverController =
      Get.find<EmbyServerController>();
  final EmbyApiService api = EmbyApiService();

  final RxList<EmbyMediaItem> libraries = <EmbyMediaItem>[].obs;
  final RxList<EmbyMediaItem> resumeItems = <EmbyMediaItem>[].obs;
  final RxMap<String, List<EmbyMediaItem>> latestItems =
      <String, List<EmbyMediaItem>>{}.obs;
  final RxBool isLoading = false.obs;
  final RxString error = ''.obs;

  final RxList<EmbyMediaItem> recentlyAddedItems =
      <EmbyMediaItem>[].obs;

  @override
  void onInit() {
    super.onInit();
    debugPrint('===== EmbyHomeController.onInit =====');
  ...
  Future<void> loadHomeData() async {
    ...
    try {
      ...
      // 4. 每个库的最新内容
      final latestMap = <String, List<EmbyMediaItem>>{};
