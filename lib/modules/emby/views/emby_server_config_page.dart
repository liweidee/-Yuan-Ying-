...
class EmbyServerConfigPage extends StatelessWidget {
  const EmbyServerConfigPage({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<EmbyServerController>()) {
      Get.put(EmbyServerController());
    }
    final controller = Get.find<EmbyServerController>();
    final theme = Theme.of(context);

    return Scaffold(
      backgroundColor: theme.colorScheme.surface,
      appBar: AppBar(
        title: const Text('Emby 服务器', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600)),
        centerTitle: false,
        elevation: 0,
        backgroundColor: theme.colorScheme.surface,
  ...
  Widget _buildEmptyState(BuildContext context, ThemeData theme, EmbyServerController controller) {
    return Center(
      child: Column(
  ...
  Widget _buildServerCard(
    ...
    ThemeData theme,
    EmbyServerController controller,
    EmbyServer server,
    bool hasToken,
  ) {
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Get.toNamed(AppPages.embyMain, arguments: {'serverId': server.id});
        },
      ),
    );
  }
  ...
  // ----- 添加对话框 -----
  void _showAddDialog(BuildContext context, EmbyServerController controller) {
    final theme = Theme.of(context);
      ...
      builder: (dialogContext) => Dialog(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Text('添加 Emby 服务器', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: theme.colorScheme.onSurface)),
        ...
        builder: (context, setState) => Dialog(
          ...
          child: Container(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('登录 Emby', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: theme.colorScheme.onSurface)),
                const SizedBox(height: 20),
                TextField(
                  controller: userCtrl,
