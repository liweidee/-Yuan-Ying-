// lib/modules/novel/views/novel_detail_page.dart
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:yuanying/modules/novel/controllers/novel_detail_controller.dart';
...
class _NovelDetailPageState extends State<NovelDetailPage> {
  ...
  void initState() {
    ...
    if (vodId.isNotEmpty) {
      controller = Get.put(NovelDetailController(), tag: vodId);
  ...
  void dispose() {
    if (vodId.isNotEmpty) {
      Get.delete<NovelDetailController>(tag: vodId);
    }
    super.dispose();
  }
  ...
  Widget _buildError(BuildContext context, NovelDetailController controller) {
    final colorScheme = Theme.of(context).colorScheme;
    return Center(
      child: Column(
  ...
  Widget _buildContent(BuildContext context, NovelDetailController controller) {
    final colorScheme = Theme.of(context).colorScheme;
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('$total 章', style: TextStyle(fontSize: 11, color: colorScheme.primary, fontWeight: FontWeight.w500)),
                    ),
                  ],
                ),
                Row(
