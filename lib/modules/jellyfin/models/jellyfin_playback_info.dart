class JellyfinMediaSource {
  ...
  factory JellyfinMediaSource.fromJson(Map<String, dynamic> json) => JellyfinMediaSource(
    ...
    streams: (json['MediaStreams'] as List?)?.map((e) => JellyfinMediaStream.fromJson(e as Map<String,dynamic>)).toList() ?? [],
  );
}
...
class JellyfinMediaStream {
  ...
  JellyfinMediaStream({required this.index, required this.type, this.codec, this.language, this.displayTitle});
  factory JellyfinMediaStream.fromJson(Map<String, dynamic> json) => JellyfinMediaStream(
