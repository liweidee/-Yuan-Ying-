...
class JellyfinFavoritePage extends StatelessWidget {
  const JellyfinFavoritePage({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<JellyfinFavoriteController>()) {
      Get.put(JellyfinFavoriteController());
    }
    final ctrl = Get.find<JellyfinFavoriteController>();
  ...
  Future<void> _confirmUnfavorite(
    ...
    JellyfinFavoriteController ctrl,
