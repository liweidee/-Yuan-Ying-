...
class JellyfinHistoryPage extends StatelessWidget {
  const JellyfinHistoryPage({super.key});

  @override
  Widget build(BuildContext context) {
    if (!Get.isRegistered<JellyfinHistoryController>()) {
      Get.put(JellyfinHistoryController());
    }
  ...
  Future<void> _confirmRemoveOne(
    ...
    JellyfinHistoryController ctrl,
  ...
  /// - 其他    → 直接打开自身详情
  void _openDetail(JellyfinMediaItem item) {
