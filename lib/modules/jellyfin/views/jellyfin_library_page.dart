...
import '../controllers/jellyfin_library_controller.dart';
import '../services/jellyfin_api_service.dart';

const Widget _loadingWidget = Center(child: M3ELoadingIndicator());

class JellyfinLibraryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (!Get.isRegistered<JellyfinLibraryController>(tag: libraryId)) {
      Get.put(
        JellyfinLibraryController(
          libraryId: libraryId,
    ...
    final ctrl = Get.find<JellyfinLibraryController>(tag: libraryId);
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              showSearch(
                context: context,
                delegate: _JellyfinLibrarySearchDelegate(ctrl),
              );
            },
          ),
      ...
      body: Obx(() {
        ...
        return GridView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return VideoCardV(
              videoItem: videoItem,
              onTap: () => Get.toNamed(AppPages.jellyfinDetail,
...
class _JellyfinLibrarySearchDelegate extends SearchDelegate {
  final JellyfinLibraryController ctrl;
  _JellyfinLibrarySearchDelegate(this.ctrl);
